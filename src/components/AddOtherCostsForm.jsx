...
import { CalendarPlus as CalendarIcon, BadgeEuro as EuroIcon, FileText as FileTextIcon, Layers } from 'lucide-react';

const AddOtherCostsForm = ({ defaultProjectId, onSuccess }) => {
  const { addOtherCost } = useExpenses();
  ...
  const handleSubmit = (e) => {
    ...
    toast({
      title: "Cost Added",
      description: "Other Cost has been successfully recorded.",
      ...
      <CardContent className="pt-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Input 
              placeholder="e.g. Server hosting fee, Software license..."
...
export default AddOtherCostsForm;